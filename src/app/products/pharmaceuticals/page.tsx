                ...
                <CardContent className="p-8">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-brand-100 rounded-xl flex items-center justify-center flex-shrink-0">
                      <product.icon className="w-7 h-7 text-brand-600" />
                    </div>
            ...
            <div className="bg-gradient-to-br from-brand-600 to-brand-500 rounded-2xl p-8 text-white">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-white/20 pb-2">
                  ...
                  <span className="text-brand-100 text-sm">3-6 months</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/20 pb-2">
                  <span>Process Package Transfer</span>
                  <span className="text-brand-100 text-sm">6-12 months</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/20 pb-2">
                  <span>CDMO Production</span>
                  <span className="text-brand-100 text-sm">Customized</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Pilot Scale-up Services</span>
                  <span className="text-brand-100 text-sm">2-4 months</span>
                </div>
              </div>
            </div>
          </div>
