...
const socialLinks = [
  { 
    name: 'Instagram', 
    href: 'https://instagram.com/envikobio', 
    icon: (
  ...
  { 
    name: 'Facebook', 
    href: 'https://facebook.com/envikobio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://linkedin.com/company/envikobio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'YouTube', 
    href: 'https://youtube.com/@envikobio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'TikTok', 
    href: 'https://tiktok.com/@envikobio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mt-6">
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  ...
                  >
                    <div className="text-white group-hover:text-brand-600 transition-colors">
                      {social.icon}
                    </div>
                  </a>
                ))}
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <Button 
                  ...
                  className="w-full bg-white hover:bg-gray-100 text-brand-600 transition-all duration-300 hover:scale-[1.02]"
                >
                  {isSubmitting ? (
                    'Subscribing...'
                  ) : (
        ...
        <div className="border-t border-brand-600 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 text-sm text-brand-200">
