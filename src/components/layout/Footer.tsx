            ...
            <div className="mt-6">
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  ...
                  >
                    {social.icon ? (
                      <social.icon className="w-4 h-4 text-white group-hover:text-brand-600 transition-colors" />
                    ) : (
                      <svg className="w-4 h-4 text-white group-hover:text-brand-600 transition-colors" viewBox="0 0 24 24" fill="currentColor">
