...
const socialLinks = [
  { 
    name: 'Instagram', 
    href: 'https://instagram.com/alvokorbio', 
    icon: (
  ...
  { 
    name: 'Facebook', 
    href: 'https://facebook.com/alvokorbio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://linkedin.com/company/alvokorbio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'YouTube', 
    href: 'https://youtube.com/@alvokorbio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  { 
    name: 'TikTok', 
    href: 'https://tiktok.com/@alvokorbio', 
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 text-sm text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@alvokorbiosolution.com" className="hover:text-white transition-colors">
